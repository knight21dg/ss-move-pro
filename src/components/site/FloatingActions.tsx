...
export function FloatingActions() {
  ...
  const { phone, whatsapp } = s?.contact ?? {};
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
      <a
        href={whatsapp ? `https://wa.me/${digits(whatsapp)}?text=Hi%20SS%20Packers%20%26%20Movers%2C%20I%27d%20like%20a%20quote` : "#"}
