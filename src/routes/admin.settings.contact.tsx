        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1 mb-2">Shown in contact page, not used for buttons.</p>
              <Input
                value={form.contact.alternate_phone}
                onChange={(e) =>
                  setForm({
                    ...form,
                    contact: { ...form.contact, alternate_phone: e.target.value },
                  })
                }
              />
            </div>
            ...
            <div>
              <Label>GSTIN</Label>
              <Input
                value={form.contact.gstin}
                onChange={(e) =>
                  setForm({ ...form, contact: { ...form.contact, gstin: e.target.value } })
                }
              />
            </div>
            <div>
