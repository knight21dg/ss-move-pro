...
export const Route = createFileRoute("/admin/settings/cta")({ component: CtaSettings });
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setForm({ ...form, cta: { ...form.cta, banner_text: e.target.value } })}
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setForm({ ...form, cta: { ...form.cta, banner_subtitle: e.target.value } })}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setForm({ ...form, cta: { ...form.cta, banner_button: e.target.value } })}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setForm({ ...form, cta: { ...form.cta, banner_link: e.target.value } })}
              />
            </div>
          </CardContent>
        </Card>
